...
public class HttpRequest {
	 ...
	 * @return JSONObject
	 */
	public static JSONObject request(String apiURL, HashMap<String, String> headers, String method,
		...
		try {
			...
			try (in; InputStreamReader isr = new InputStreamReader(in); BufferedReader br = new BufferedReader(isr)) {
				String line = null;
